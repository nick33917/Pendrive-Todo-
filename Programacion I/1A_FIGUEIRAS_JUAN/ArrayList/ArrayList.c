 ...
 *                  - (0) if ok
 */
int resizeUp(ArrayList* this)// Bien
{
    int returnAux = -1;
    void** aux_pElements;
 ...
 *                  - (0) if ok
 */
int resizeDown(ArrayList* this)// Bien
{
    int returnAux = -1;
    void** aux_pElements;
 ...
 *                  - ( 0) if Ok
 */
int expand(ArrayList* this,int index)// Bien
{
    int returnAux = -1, i;
...
void* al_get(ArrayList* this, int index)
{
    ...
    if(this != NULL)
    {
        if(index < this->size && index >= 0)
        {
            returnAux = this->pElements[index]; //*(this->pElements+index)
        }
    }
...
int al_remove(ArrayList* this,int index)
{
    ...
    returnContract = contract(this, index);
...
int al_isEmpty(ArrayList* this)
{
    ...
    if(this != NULL)
    {
        if(this->len(this) == 0) //Esta vacio
        {
            returnAux = 1;
        }
        else
        {
            returnAux = 0; //No esta vacio.
        }
    }
