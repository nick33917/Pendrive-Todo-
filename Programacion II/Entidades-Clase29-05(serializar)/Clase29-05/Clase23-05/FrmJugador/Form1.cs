...
// escritura del archivo 
 ...
 // lectura del archivo
        ...
        {
            Jugador jug = new Jugador("nicolas", "fattori", EPuesto.Delantero);
        ...
        {
            Jugador jug = new Jugador("","",EPuesto.Arquero);
            Jugador j = ((ISerializableBinario)jug).Deserializar();
        ...
        {
            Jugador jug = new Jugador("", "", EPuesto.Arquero);
            Jugador j = ((ISerializableXML)jug).Deserializar();
            MessageBox.Show(j.ToString());
