...
namespace Prueba
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ArticuloImportado art1 = new ArticuloImportado("Argentina", 30, 560, "CocaCola", 1000, 2);
            ElBolicheDeToni.ComprarArticulo(art1);
            ...
            ElBolicheDeToni.VenderArticulo(art1, 1);
